...
3. 次のコマンドで起動します。
   ...
   ```
   💡 Python環境の準備がまだの方は、本マニュアルと`karipom_companion.py`をChatGPTなどのAIに読み込ませ、指示にしたがって進めてください。
...
💡 BlackHoleの導入がまだの方は、ChatGPTなどのAIに相談しながら進めてください。本節では、導入済みの方向けに使い方の流れを説明します。
