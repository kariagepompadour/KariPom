...
subtitle: "KariPom User Manual — Ver. 4.0"
date: "2026年8月"
lang: ja
---
...
| Arduinoソース | かりポム本体（CoreS3）のファームウェアです。 |
| Pythonソース | KariPom Companion・KariPom Desktopなど、PC側のプログラムです。 |
| 3Dデータ | 筐体（ボディ）を3Dプリントするための設計データです。 |
...
| 構成 | 必要なもの | 体験できること |
|---|---|---|
| **① KariPom Desktop** | PCのみ（CoreS3不要） | かりポムとの会話・口パクをもっとも手軽に体験できる、いわば体験版（2.3） |
...
A. 本書には詳しい電子工作の内容をあえて載せていません。CoreS3にPCM1808＋Pico2を追加する拡張の配線図・部品表・組み立て手順は、「**Karipom Ear 設計・製作マニュアル**」としてGitHubで公開しています。かりポム本体のArduinoソース、PC側のPythonソース、3Dプリント用データもあわせて公開しています（1.1）。
