...
| Lighting（背景演出） | ディスコ調の光やレトロゲーム風のスクリーンセーバーなど、18種類の画面演出を楽しめます。Visualizerと組み合わせ可能です。 | 第14章 |
...
| Lighting選択 | 18種類から選択（面演出は1つ、オーバーレイは重ねて選択可）。 |
...
| Lighting | ライティング。画面の背景演出機能。18種類。音に反応するものと反応しないものがある。 |
