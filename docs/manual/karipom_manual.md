...
subtitle: "KariPom User Manual — Ver. 3.2"
date: "2026年8月"
lang: ja
---
...
現在では、CoreS3の実機を持っていない方でも、PCだけで動く「**KariPom Desktop**」（2.3）でこの世界を体験できるようになっています。さらに、CoreS3にPCM1808マイクとRaspberry Pi Picoを追加した拡張構成（第12章）では、PCを使わずにBBXを楽しめます。設計図・回路図・製作マニュアルはGitHubで公開予定で、この構成も含めて、かりポムは今も継続的に改良が続けられているプロジェクトです。
...
**① KariPom Desktop** — PCだけで、かりポムとの会話や口パクを気軽に体験できます。CoreS3の実機は不要です（2.3）。
...
**③ CoreS3＋PCM1808＋Pico2** — 発展構成です。GitHubで公開している設計図・回路図・製作マニュアルを使って拡張すると、PCを使わずにBBXを楽しめる構成へと発展させられます（第12章）。
