...
subtitle: "KariPom User Manual — Ver. 4.4"
date: "2026年8月"
lang: ja
---

【図：表紙イラスト。作者の製作例であるピンクとティファニーブルーのかりポム2体が並んでいる写真】
...
![作者製作機の分解例（CoreS3＋DIN Base、SG90×2、ジョイスティック、Karipom Ear収納部）](images/ch5_overall_disassembly.jpg){width=70%}
...
![SG90サーボの取り付け例（サーボホーンはSG90付属のものをそのまま使用）](images/ch5_sg90_closeup.jpg){width=60%}

📝 写真は作者製作機の一例です。

![Grove ジョイスティックモジュールの取り付け例](images/ch5_joystick.jpg){width=70%}
...
![Karipom Ear収納部の一例（PCM1808基板・Raspberry Pi Pico 2 H）](images/ch5_ear_compartment.jpg){width=60%}
